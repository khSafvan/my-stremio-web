...
const MetaItem = React.memo(
    ({
        ...
        const href = React.useMemo(() => {
            return typeof customHref === 'string'
                ? customHref
                : getMetaDetailsHref(deepLinks);
        ...
        const dismissOnClick = React.useCallback(
            (event) => {
                event.preventDefault();
        ...
        const playOnClick = React.useCallback(
            (event) => {
                event.preventDefault();
                event.stopPropagation();
                onPlayClick(event);
        ...
        return (
            ...
            >
                <Button
                    ...
                    className={styles['meta-item-link']}
                ...
                >
                    ...
                    >
                        {onDismissClick ? (
                            ...
                            >
                                ...
                                />
                                <div
                                    className={styles['dismiss-icon-backdrop']}
                                />
                            </div>
                        ) : null}
                        {watched ? (
                        ...
                        {onPlayClick ? (
                            ...
                            >
                                ...
                                <div
                                    className={styles['play-icon-background']}
                                />
                            </div>
                        ) : null}
                        {progress > 0 ? (
                    ...
                    hasOptions ? (
                        <div
                            className={classnames(
                                styles['title-bar-container'],
                                { [styles['has-menu']]: hasOptions }
                            )}
                        >
